...
export default function EditServerModal({ server, isOpen, onClose, onSave }: EditServerModalProps) {
  const [serverData, setServerData] = useState<ServerConfig>(server);
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Server Endpoint</label>
              <input
                type="text"
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
